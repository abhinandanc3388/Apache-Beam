...
public class PartitionExample {
    ...
    public static void main(String[] args) {
        ...
        PCollection<String> pCustList1 = p.apply(TextIO.read().from("section3/src/main/resources/Input/Partition.csv"));
        ...
        p0.apply(TextIO.write().to("section3/src/main/resources/Output/p0.csv").withNumShards(1).withSuffix(".csv"));
        p1.apply(TextIO.write().to("section3/src/main/resources/Output/p1.csv").withNumShards(1).withSuffix(".csv"));
        p2.apply(TextIO.write().to("section3/src/main/resources/Output/p2.csv").withNumShards(1).withSuffix(".csv"));
