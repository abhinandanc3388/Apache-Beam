...
public class MapElementsSimpleFunction {
    ...
    public static void main(String[] args) {
        ...
        PCollection<String> pUserList= p.apply(TextIO.read().from("section3/src/main/resources/Input/user.csv"));

        //Using Simple Function

        PCollection<String> pOutput= pUserList.apply(MapElements.via(new User()));

        pOutput.apply(TextIO.write().to("section3/src/main/resources/Output/user_output.csv").withNumShards(1).withSuffix(".csv"));
